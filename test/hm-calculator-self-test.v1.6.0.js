/*
 * HealingMart Calculator Self Test v1.6.0
 * Target: Calculator app v4.8.0 / CSS v4.2.0 / Registry v3.6.0
 *
 * Automates:
 * - GitHub deployment file integrity
 * - Registry 12 categories / 360 calculators
 * - 110 calculator module registration
 * - 820 formula QA cases
...
(function (w, d) {
  ...
  function ensurePanel() {
    ...
    sh.querySelector('[data-a="txt"]').onclick = function(){
      download("HealingMart_Calculator_Self_Test_v1.3.0.txt","\ufeff"+reportText());
    };
    sh.querySelector('[data-a="json"]').onclick = function(){
      download("HealingMart_Calculator_Self_Test_v1.3.0.json",JSON.stringify({
