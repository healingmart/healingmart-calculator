/*
 * HealingMart Calculator Self Test v1.0.0
...
(function (w, d) {
  ...
  function ensurePanel() {
    ...
    sh.querySelector('[data-a="txt"]').onclick = function(){
      download("HealingMart_Calculator_Self_Test_v1.0.0.txt","\ufeff"+reportText());
    };
    sh.querySelector('[data-a="json"]').onclick = function(){
      download("HealingMart_Calculator_Self_Test_v1.0.0.json",JSON.stringify({
